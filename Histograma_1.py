...
hist_values=cv2.calcHist([img_bgr], channels=[1], mask=None,histSize=[256],ranges=[0,256]) #Calcula el histograma par la matriz azul, parametro de imagen, canal rgb, mascara, tamaño de histograma y rango
